...
#   K8_STATIC_DIR  (output/covr_static_k8)      K8 static-mask run root
...
K8_STATIC_DIR="${K8_STATIC_DIR:-output/covr_static_k8}"
...
# --- preflight: data dirs ----------------------------------------------------
if [ ! -d "${PROBE_DIR}" ]; then
  echo "budget probe dir not found: ${PROBE_DIR}" >&2
